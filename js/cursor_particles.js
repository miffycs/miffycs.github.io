    ...
    var e = function(a, b) {
        ...
        l = function(c, d) {
            ...
            return e.prototype.keyboard = function() {
                ...
                var c, d, e;
                if (b.preventDefault(), c = a(this).data("glide-trigger").split(" "), !this.disabled)
                    for (d in c) e = a(c[d]).data("glide_api"), e.pause(), e.go(a(this).data("glide-dir"), this.activeTrigger), e.play()
...
function(a, b, c) {
    a.$win = a.$(b), a.$doc = a.$(c), a.events || (a.events = {}), a.events.resizeend = {
            ...
            setup: function() {
                ...
                return a.utils.is.fn(c[0]) ? b = c[0] : a.utils.is.number(c[0]) ? d.delay = c[0] : a.utils.is.object(c[0]) && (d = a.$.extend({}, d, c[0])), e = a.utils.uid("resizeend"), f = a.$.extend({
                    delay: a.$.event.special.resizeend.defaults.delay
                }, d), g = f, h = function(b) {
